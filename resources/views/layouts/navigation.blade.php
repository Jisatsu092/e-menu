<nav x-data="{
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center space-x-4">
                <!-- Mobile Menu Button (Untuk Semua User) -->
                ...
                <div class="hidden sm:flex ml-4 space-x-4">
                    ...
                    <div class="relative" x-data="{ masterOpen: false }" @click.outside="masterOpen = false">
                        ...
                        <div x-show="masterOpen" x-transition class="absolute mt-2 w-48 bg-white rounded-md shadow-lg border border-gray-100">
                    ...
                    <!-- User Interface (Hanya Desktop untuk Admin) -->
                    <div class="relative" x-data="{ userInterfaceOpen: false }" @click.outside="userInterfaceOpen = false">
                        ...
                        <div x-show="userInterfaceOpen" x-transition class="absolute mt-2 w-48 bg-white rounded-md shadow-lg border border-gray-100">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="relative" x-data="{ profileOpen: false }" @click.outside="profileOpen = false">
                    ...
                    <div x-show="profileOpen" x-transition class="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg border border-gray-100 z-50">
    ...
    <!-- Mobile Sidebar (Simplified untuk Semua User) -->
    ...
    <aside x-show="open" x-transition class="fixed top-0 left-0 w-64 h-full bg-white shadow-lg z-50 transform transition-transform sm:hidden">
        ...
        <div class="p-4 space-y-4">
            <!-- Menu Mobile untuk Semua User -->
            <button @click="window.location.href='{{ route('beranda') }}'" 
                    class="w-full px-4 py-3 rounded-md hover:bg-gray-100 transition">
                Beranda
            </button>

            <!-- Hanya Tampilkan ke User Biasa -->
            @can('role-U')
            <div class="space-y-2">
                <a href="{{ route('menu') }}" class="block px-4 py-3 hover:bg-gray-100 transition">Menu</a>
                <a href="{{ route('cart') }}" class="block px-4 py-3 hover:bg-gray-100 transition">Keranjang</a>
                <a href="{{ route('history') }}" class="block px-4 py-3 hover:bg-gray-100 transition">Riwayat</a>
            </div>
            @endcan
...
<!-- Tambahkan Alpine Collapse Plugin -->
