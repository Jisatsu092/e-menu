                            ...
                            <details class="group border-t">
                                ...
                                <div class="ml-8 mr-4 my-2">
                                    ...
                                    <div class="grid grid-cols-12 gap-4 px-4 py-2 border-t hover:bg-gray-50">
                                        ...
                                        <div class="col-span-3">Rp{{ number_format($detail->subtotal, 0, ',', '.') }}</div>
                                    </div>
                                    @endforeach
                                </div>
                            </details>
                        ...
                        <details class="border rounded-lg bg-white">
                            ...
                            <div class="px-4 pb-4 space-y-3 border-t">
                                ...
                                <div class="p-3 bg-gray-50 rounded-lg">
                                    <p class="text-sm"><span class="font-medium">Toping:</span> {{ $detail->toping->name ?? '-' }}</p>
                                    <p class="text-sm"><span class="font-medium">Qty:</span> {{ $detail->quantity }}</p>
